...
public class HexagonController {
	...
	private static final Logger LOGGER = Logger.getLogger(HexagonController.class.getName());
	
	private static HexagonController instance = new HexagonController();
	...
	public static HexagonController getInstance() {
		return instance;
	}
}